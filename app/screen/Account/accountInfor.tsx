...
const AccountInfor: React.FC = ({ navigation }: any) => {
  ...
  const handlePayment = (appID: string) => {
    payment.paymentMutation.mutate(appID);
  };
          ...
          <>
            ...
            <View style={styles.infoRow}>
              ...
              <Text style={styles.value}>
                {userDetails.accountStatus ? 'Active' : 'Inactive'}
              </Text>
            </View>
            <View style={styles.infoRow}>
          ...
          appointments.map((appointment) => (
            ...
            >
              <Text style={styles.appointmentText}>
                {appointment.appointmentDetails[0]?.serviceName ||
                  appointment.appointmentDetails[0]?.comboName ||
              ...
              <Text
                style={[
                  ...
                  getAppointmentStatusStyle(appointment.appointmentStatus),
                ]}
              >
                Status:{' '}
                {appointment.appointmentStatus === 'Đã thanh toán'
                  ? 'PAID'
              ...
              <View style={styles.buttonContainer}>
                ...
                {appointment.appointmentStatus !== 'Đã thanh toán' &&
                  appointment.appointmentStatus !== 'CANCELLED' && (
                    <TouchableOpacity
                      onPress={() =>
                        handlePayment(appointment.appointmentID.toString())
                      }
              ...
              {selectedAppointment.appointmentDetails.map((detail) => (
                <View key={detail.appointmentDetailID} style={styles.detailRow}>
                  <Text style={styles.detailText}>
                    Service/Combo: {detail.serviceName || detail.comboName}
                  </Text>
                  <Text style={styles.detailText}>
                    Price:{' '}
